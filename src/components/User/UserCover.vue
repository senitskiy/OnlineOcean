    ...
    <div class="container">
      <div class="user-cover__inner">
        <div class="user-cover__profile">
          ...
          userId='34'
          ></app-profile>
          <div class="user-cover__profile-col">
          ...
          <div class="user-cover__profile-col">
            ...
            @click='copyId(this.content.userId)'
            >
...
export default {
  ...
  computed: {
    shortId() {
      let first = this.content.userId.slice(0, 4),
          second = this.content.userId.slice(-4, this.content.userId.length);
