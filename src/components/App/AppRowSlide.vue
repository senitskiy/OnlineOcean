<template>
  ...
  :class='[activeState, verifiedState]'
  >
    ...
    <span class="row__slide-bottom row-bottom">
      ...
      <router-link class="row__slide-account row-bottom__right"
      to='/autor-n'
      >
        <span class="row__slide-autorwrapper">
          <img src="@/assets/images/temp/user-big-1.jpg" alt="" />
        </span>
        <span class="row__slide-tag">
          {{ autor }}
        </span>
      </router-link>
    </span>
...
export default {
  ...
  computed: {
    ...
    verifiedState(){
      return this.verifiedAccount ? "row__slide--verified" : ""
    }
  },
};
</script>