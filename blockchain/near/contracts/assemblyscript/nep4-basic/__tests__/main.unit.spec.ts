...
got this all working, ran all the NEAR commands to mint, view, list buy

Next:
we can use near-api-js on the front end, to talk to our smart contract:
https://docs.near.org/docs/api/naj-quick-reference

so should be easy to plug this into a front end, put out testnet accounts etc in there
and call the methods on our contract from the front end
